...
const CreateQRcode = (props) => {
  ...
  const  handleClick = () => {
    ...
    return (
      ...
      centered size="xl" isOpen={modal} toggle={toggle} className={className} unmountOnClose={unmountOnClose} >
                <ModalHeader toggle={toggle}> show qrcode</ModalHeader>
                <ModalBody>
                 <p style={{ color: "black", fontWeight: 'bold', textAlign: "center" }}>  {props.url}</p>
